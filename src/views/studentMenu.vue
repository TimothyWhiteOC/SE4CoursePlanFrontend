  ...
  <div class="dropdown">
    ...
    <div v-if="active">
      <div class="dropdown-content">
        ...
        <a><router-link :to="{ name: 'coursePlan'}">View Course Plan</router-link></a>

        <!--<a><router-link :to="{ name: 'editStudent'}">Edit Profile?</router-link></a>-->

        <!--<a><router-link :to="{ name: 'addStudentCourse'}">Register for a Course</router-link></a>-->
      </div>
   </div>
</div>

   <h2 class = "title">Student Menu</h2>
    
    <h1>Welcome, {{this.student.fName}} {{this.student.lName}}</h1>
